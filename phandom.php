...
<head>
    ...
    <script src="phandom/js/jsapi.js"></script>
    <script src="phandom/js/jquery.min.js"></script>
    <script src="phandom/js/phandom-urlfix.js"></script>

    <!-- CSS & JS: FB Friend Selector-->
    <link type="text/css" href="phandom/friend-selector/jquery.friend.selector.css" rel="stylesheet" />
    <script type="text/javascript" src="phandom/friend-selector/jquery.friend.selector-1.2.js"></script>

    <!-- Canonical -->
    <link rel="canonical" href="http://phandom.co<?php echo $params; ?>"/>

    <!-- CSS: FB Button & Custom Bootstap-->
    <link type="text/css" href="phandom/css/fb-buttons.css" rel="stylesheet" />
    <link href="phandom/css/bootstrap.css" rel="stylesheet" media="screen">
    <script type="text/javascript" src="phandom/js/bootstrap.min.js"></script>
                ...
                <div class="row" style="margin-top:10px;">
                    <div class="span8" style="min-width:770px;">
                        <div class="row">
                            <div class="span4">
                                <a href="/">
                                    <img src="phandom/img/logo.png">
                                </a>
                                <!--
                                <a href="http://www.phandom.co">
                                    <span class="lobster logo" style="color:#F1238D">Phandom</span>
                                    <img src="phandom/img/shuffle2.png" style=" margin-left: -11px; margin-bottom: -8px; vertical-align:default">
                                </a>
                                -->
                        ...
                        <div class="row">
                            <div class="span8" >
                                <span style="position:relative;">
                                    <div class="share">
                                        <div class="rectangle">
                                            <img class="tshare" src="phandom/img/tshare.png">
                                            <!--<img class="fbshare" src="phandom/img/fbshare2.png">-->
...
<form>
  <fieldset>
    ...
    <img src="phandom/img/google_search_box.gif" style="float:right">
    </legend>
